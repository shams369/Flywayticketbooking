...
<%@ page import="AllLayout.*,com.digitalbd.flights,com.digitalbd.Airports,java.util.ArrayList,java.util.Iterator" %>
...
<%
	...
	ArrayList<Airport> AirportList = sts.getAll();
	Iterator stationIterator = AirportList.iterator();
%>
