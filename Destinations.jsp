...
if(request.getParameter("save_all") != null){
	...
	for(int j = 0; j<station_toAr.length; j++){
		...
		tempDesti.airport_from = request.getParameter("station_from");
		tempDesti.flight_id= request.getParameter("dst_train");
		tempDesti.airport_to= station_toAr[j];
	...
	<% }else{ %>
		<div class="rs_box" style="overflow:auto;">
			<form class="ticket_selecting_form" method="post" name="frm_deslist">
				<h2 class="title"> Flight Name: Emirates <br>Airport From: Dubai </h2>
				<table class="table table_des_seat" id="table_des_list">
					...
					while(itrTemp.hasNext()){
						...
						Airport tempToStation = tempToFromStation.getAirport(tempDestination.get("station_to"));
						%>
						<tr>
							<td>
								<div class="input-group">
