...
INSERT INTO `booking` (`id`, `destination_id`, `booking_date`, `journey_date`, `flight_id`, `seat_numbers`, `passenger_id`, `number_of_seat`, `payment_status`, `status`, `note`) VALUES
...
CREATE TABLE `destinations` (
  `id` int(100) NOT NULL,
  `airport_from` int(20) NOT NULL,
  `airport_to` int(20) NOT NULL,
...
INSERT INTO `destinations` (`id`, `airport_from`, `airport_to`, `flight_id`, `time`, `status`, `fare`, `last_activity`, `last_modify_by`, `total_seat`, `seat_range`, `type`) VALUES
...
INSERT INTO `airports` (`id`, `name`, `address`, `contact`) VALUES
(1, 'Dubai', 'Dubai, UAE', '0097133435951'),
(2, 'Doha ', 'Qatar ', '0097400202'),
(3, 'Toranto', 'Canada', '00971733435957'),
(4, 'Newyork', 'USA', '00200081733'),
(6, 'Singapore', 'singapore', '00971733435951'),
(7, 'London','UK', '044733435951');
...
CREATE TABLE `flights` (
  ...
  `name` varchar(50) NOT NULL,
  `total_seat` int(5) NOT NULL,
  `type` varchar(20) NOT NULL DEFAULT 'Domestic'
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
(2, 'B207', 'Emirates', 180, 'International'),
(3, 'j152', 'Qatar Airways', 180, 'International'),
(4, 'SNB-59', 'Aircanada', 100, 'International'),
(8, '105', 'Singapore Airlines', 110, 'Firstclass'),
(9, '106', 'American Airlines', 142, 'Firstclass'),
(10, '108', 'British Airlines', 100, 'FirstClass');
