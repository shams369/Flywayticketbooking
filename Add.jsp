...
<%@ page import="com.digitalbd.Helper,com.digitalbd.User,com.digitalbd.flights,java.util.*" %>
<%
	String message = "";
	if(request.getParameter("create flight") != null){
				...
				<div class="rs_form_box">
					...
					<div class="input-group">
						<div class="form-group">
							...
							<%
							HashMap<String,String> coach = Helper.FlightClass();
