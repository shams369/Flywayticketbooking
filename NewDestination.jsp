				...
				<div class="rs_form_box">
					...
					<div class="input-group">
						...
						<select class="form-contoller">
							<option value="tista_101">Air India</option>
							<option value="tista_101">Jet Airways</option>
							<option value="tista_101">Indigo</option>
							<option value="tista_101">SpiceJet</option>
						</select>
					</div>
					<div class="input-group">
						<label>Code</label>
